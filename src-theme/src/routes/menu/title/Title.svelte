    ...
    onMount(() => {
        setTimeout(async () => {
            ...
            if (clientUpdate.update) {
                notification.set({
                    title: `EvilBounce ${clientUpdate.update.clientVersion} has been released!`,
                    message: `Download it from github.com/gregoirener/evilbounce!`,
                    error: false,
                    delay: 99999999
                });
            }
        ...
        <div class="content">
            <div class="main-buttons">
                {#if regularButtonsShown}
                    ...
                    <MainButton title="EvilBounce" icon="liquidbounce" on:click={toggleButtons} index={2}/>
            ...
            <div class="social-buttons" transition:fly|global={{duration: 700, y: 100}}>
                <ButtonContainer>
                    ...
                    <IconTextButton title="EvilBounce" icon="icon-liquidbounce.net.svg"
