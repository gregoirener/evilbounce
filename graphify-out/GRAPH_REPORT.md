...
2. `regular()` - 117 edges
3. `Vec3` - 88 edges
4. `../../../integration/types.js` - 87 edges
5. `variable()` - 81 edges
6. `../../../integration/events.js` - 63 edges
7. `jsonObject()` - 57 edges
8. `ValueGroup` - 51 edges
9. `Color4b` - 47 edges
10. `markAsError()` - 46 edges
...
Cohesion: 0.03
Nodes (59): Account, Alignment, BindAction, BindModifier, BindSetting, BlocksSetting, BooleanSetting, Browser (+51 more)
...
Cohesion: 0.07
Nodes (4): MixinShaderManager, ClientRenderPipelines, GUI, JCEF
...
- **Are the 87 inferred relationships involving `Vec3` (e.g. with `.read()` and `.render()`) actually correct?**
  _`Vec3` has 87 INFERRED edges - model-reasoned connections that need verification._
